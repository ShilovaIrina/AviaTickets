...
public class AviaSouls {
    ...
    public Ticket[] search(String from, String to) {
        ...
        Arrays.sort(result); // метод, который отсортирует наш получившийся массив
        return result;
    }
    ...
    public Ticket[] searchAndSortBy(String from, String to, Comparator<Ticket> comparator) {
        ...
        Arrays.sort(result, comparator); // метод, который отсортирует наш получившийся массив по отрезку времени в пути
        return result;
    }
}
